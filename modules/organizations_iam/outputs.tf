...
output "organizations" {
  value       = distinct(local.bindings_formated[*].organization_name)
  description = "Organizations created for bindings."
}

output "organization_roles" {
  value       = distinct(local.bindings_formated[*].role_name)
  description = "Roles to be assigned to organization."
}
