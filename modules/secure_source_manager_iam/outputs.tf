...
output "instances" {
  ...
  depends_on  = [google_secure_source_manager_instance_iam_binding.ssm_instance_iam_authoritative, google_secure_source_manager_instance_iam_member.ssm_instance_iam_additive, ]
}
